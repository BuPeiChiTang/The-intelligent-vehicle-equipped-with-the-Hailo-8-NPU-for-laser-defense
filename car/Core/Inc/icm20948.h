...
//#define B0_TEMP_OUT_H 0x41 // 温度数据高字节
//#define B0_TEMP_OUT_L 0x42 // 温度数据低字节
#define TEMP_SENSITIVITY 333.87f // 温度传感器灵敏度，根据数据手册
#define TEMP_OFFSET 21.0f // 温度偏移量，根据数据手册
