...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, m1_in1_Pin|m1_in2_Pin|m2_in1_Pin|m2_in2_Pin
  ...
  /*Configure GPIO pins : begin_flag_Pin stop_flag_Pin */
  GPIO_InitStruct.Pin = begin_flag_Pin|stop_flag_Pin;
